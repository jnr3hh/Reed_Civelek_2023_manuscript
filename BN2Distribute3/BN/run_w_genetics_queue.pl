...
sub submit2Que  {
	...
	for ($i=$j; $i<$j+$NS; $i++) {
		...
		print OUT "#SBATCH -t 10:00:00\n";
		#print OUT "#BSUB -q $queue\n";
                print OUT "#SBATCH -p standard\n";
		#print OUT "#BSUB -R rusage[mem=$memory]\n";
                #print OUT "#SBATCH --mem 256000\n";
		#print OUT "#BSUB -e stderr.$i\n";
                print OUT "#SBATCH -e stderr.$i\n";
                #print OUT "#BSUB -o result.out.$i\n";
		print OUT "#SBATCH -o result.out.$i\n";
		#print OUT "#BSUB -P $alloc\n";
                print OUT "#SBATCH -A Civeleklab\n";
...
$prog = "/home/jnr3hh/BN2Distribute/BN/testBN -f 0 -M 500000 ";
print "HERE1\n";
